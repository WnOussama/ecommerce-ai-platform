...
\begin{itemize}
    ...
    \item \textbf{Fournisseur de modèle de langage} (OpenAI, Anthropic, ou un fournisseur simulé en environnement de développement) : acteur externe sollicité pour la génération de réponses en langage naturel.
\end{itemize}
